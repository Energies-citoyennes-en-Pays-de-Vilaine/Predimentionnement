...
CA_REDON_ENT_CONSUMPTION = 218_011 * 1e6 / (365*24)#average consumption in W
...
NB_PARTICULIERS = 200
SOLAR_TOTAL_PROD = (0.728 * 365 * 24) # production in Redon and Pontchateau over the course of the 2020 year
PRODUCTION_SCALING_FACTOR = 1e6  / (365*24) / (CA_PONTCHATEAU_POPULATION + CA_REDON_POPULATION)
ADD_SOLAR = True
BIOENERGY_TOTAL_PROD = (0.69 * 365 * 24) # production in Redon and Pontchateau over the course of the 2020 year
ADD_BIOENERGY = True
HAS_BATTERY   = False
...
class ConfigObject():
	...
	CA_REDON_PRO_CONSUMPTION       : float
	CA_REDON_ENT_CONSUMPTION       : float
	CA_PONTCHATEAU_POPULATION      : int
	CA_PONTCHATEAU_RES_CONSUMPTION : float
	CA_PONTCHATEAU_PRO_CONSUMPTION : float
	CA_PONTCHATEAU_ENT_CONSUMPTION : float
	NB_PARTICULIERS                : int
...
config = ConfigObject(
	...
	CA_REDON_PRO_CONSUMPTION       = CA_REDON_PRO_CONSUMPTION  ,
	CA_REDON_ENT_CONSUMPTION       = CA_REDON_ENT_CONSUMPTION  ,
	CA_PONTCHATEAU_POPULATION      = CA_PONTCHATEAU_POPULATION ,
	CA_PONTCHATEAU_RES_CONSUMPTION = CA_PONTCHATEAU_RES_CONSUMPTION,
	CA_PONTCHATEAU_PRO_CONSUMPTION = CA_PONTCHATEAU_PRO_CONSUMPTION,
	CA_PONTCHATEAU_ENT_CONSUMPTION = CA_PONTCHATEAU_ENT_CONSUMPTION,
